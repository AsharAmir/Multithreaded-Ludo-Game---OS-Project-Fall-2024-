...
QT_MOC_LITERAL(1, 13, 13), // "tokenCaptured"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "playerId"
QT_MOC_LITERAL(4, 37, 13) // "turnCompleted"

    },
    "PlayerThread\0tokenCaptured\0\0playerId\0"
    "turnCompleted"
};
...
void PlayerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tokenCaptured((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->turnCompleted((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerThread::tokenCaptured)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PlayerThread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerThread::turnCompleted)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PlayerThread::tokenCaptured(int _t1)
{
...
// SIGNAL 1
void PlayerThread::turnCompleted(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
